...
Although the dataset was taken and used from Kaggle, due to its synthetic nature the dataset was uniform and would return near identical median and average values. For this reason RANDBETWEEN was used to create a new column called 'New_Onset_Days' which would return values with more variation.
